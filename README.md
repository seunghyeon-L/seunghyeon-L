## 👋 Hi there!
[![GitAnimals](https://render.gitanimals.org/farms/seunghyeon-L)](https://gitanimals.org/)
...
[![Top Langs](https://github-readme-stats-beta-sage.vercel.app/api/top-langs/?username=seunghyeon-L&layout=compact&theme=transparent&hide_border=true)](https://github.com/seunghyeon-L)
...
- 🔭 **I’m currently working on:** URL 단축기 프로젝트 (React, Kotlin/Spring Boot, AWS/Docker) 및 Git Flow 기반 협업 프로세스 구축
- 🌱 **I’m currently learning:** Valkey(C), Yocto Project(Embedded OS), Python
- 👯 **I’m looking to collaborate on:** 딥다이브 시스템 프로젝트 및 오픈소스 기여
- 🤔 **I’m looking for help with:** 컴퓨터 그래픽스, OS, 네트워크 기초 이론
- 💬 **Ask me about:** Android 앱 개발 (Kotlin), Spring Boot 서버 구축